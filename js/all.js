...
(function() {
    ...
    AbstractChosen.prototype.keyup_checker = function(evt) {
      ...
      switch (stroke) {
        case 8:
          ...
          break;
        case 13:
          //if (this.results_showing && (!this.tag_added)) {  
          //} else {
          	//this.tag_added =  false;
          //}
	        evt.preventDefault(); 
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.form_field_jq.bind("chosen:addedtag.chosen", function(evt) {
        _this.tag_added =  true;
      });
	...
	Chosen.prototype.close_field = function() { $(document).unbind("click.chosen", this.click_test_action); this.active_field = false; this.results_hide(); this.container.removeClass("chosen-container-active"); this.form_field_jq.trigger('chosen:blur', {chosen: this}); /* SmokinMedia */ this.clear_backstroke(); this.show_search_field_default(); return this.search_field_scale(); }; Chosen.prototype.activate_field = function() { this.container.addClass("chosen-container-active"); this.active_field = true; this.search_field.val(this.search_field.val()); this.form_field_jq.trigger('chosen:focus', {chosen: this}); /* SmokinMedia */ return this.search_field.focus(); };
